...
class PLN() : OrganizationCurrency() {
    @SerializedName("ask")
    @Expose
    ...
    override fun getName(context: Context): String? {
        return context.resources.getString(R.string.polish_zloty)
    }

    override fun getImage(context: Context): Drawable? {
        return context.resources.getDrawable(R.drawable.ic_poland_flag)
    }

    override fun getAbr(context: Context): String? {
        return context.resources.getString(R.string.PLN)
    }
    ...
    companion object CREATOR : Parcelable.Creator<PLN> {
        override fun createFromParcel(parcel: Parcel): PLN {
            return PLN(parcel)
        }

        override fun newArray(size: Int): Array<PLN?> {
