...
class AUD() : OrganizationCurrency() {
    ...
    override fun getName(context: Context): String? {
        return context.resources.getString(R.string.australian_dollars)
    }

    override fun getImage(context: Context): Drawable? {
        return context.resources.getDrawable(R.drawable.ic_australia_flag)
    }

    override fun getAbr(context: Context): String? {
        return context.resources.getString(R.string.AUD)
    }
    ...
    companion object CREATOR : Parcelable.Creator<AUD> {
        override fun createFromParcel(parcel: Parcel): AUD {
            return AUD(parcel)
        }

        override fun newArray(size: Int): Array<AUD?> {
