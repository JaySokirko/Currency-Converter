...
class EGP() : OrganizationCurrency() {
    ...
    override fun getName(context: Context): String? {
        return context.resources.getString(R.string.egyptian_pounds)
    }

    override fun getImage(context: Context): Drawable? {
        return context.resources.getDrawable(R.drawable.ic_egypt_flag)
    }

    override fun getAbr(context: Context): String? {
        return context.resources.getString(R.string.EGP)
    }
    ...
    companion object CREATOR : Parcelable.Creator<EGP> {
        override fun createFromParcel(parcel: Parcel): EGP {
            return EGP(parcel)
        }

        override fun newArray(size: Int): Array<EGP?> {
