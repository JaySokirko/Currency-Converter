...
class HRK() : OrganizationCurrency() {
    @SerializedName("ask")
    @Expose
    ...
    override fun getName(context: Context): String? {
        return context.resources.getString(R.string.croatian_coons)
    }

    override fun getImage(context: Context): Drawable? {
        return context.resources.getDrawable(R.drawable.ic_croatia_flag)
    }

    override fun getAbr(context: Context): String? {
        return context.resources.getString(R.string.HRK)
    }
    ...
    companion object CREATOR : Parcelable.Creator<HRK> {
        override fun createFromParcel(parcel: Parcel): HRK {
            return HRK(parcel)
        }

        override fun newArray(size: Int): Array<HRK?> {
