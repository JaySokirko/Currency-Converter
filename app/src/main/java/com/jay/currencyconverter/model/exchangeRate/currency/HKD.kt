...
class HKD() : OrganizationCurrency() {
    @SerializedName("ask")
    @Expose
    ...
    override fun getName(context: Context): String? {
        return context.resources.getString(R.string.hong_kong_dollars)
    }

    override fun getImage(context: Context): Drawable? {
        return context.resources.getDrawable(R.drawable.ic_hong_kong_flag)
    }

    override fun getAbr(context: Context): String? {
        return context.resources.getString(R.string.HKD)
    }
    ...
    companion object CREATOR : Parcelable.Creator<HKD> {
        override fun createFromParcel(parcel: Parcel): HKD {
            return HKD(parcel)
        }

        override fun newArray(size: Int): Array<HKD?> {
