...
class KGS() : OrganizationCurrency() {
    @SerializedName("ask")
    @Expose
    ...
    override fun getName(context: Context): String? {
        return context.resources.getString(R.string.kgs_of_kyrgyzstan)
    }

    override fun getImage(context: Context): Drawable? {
        return context.resources.getDrawable(R.drawable.ic_kyrgyzstan_flag)
    }

    override fun getAbr(context: Context): String? {
        return context.resources.getString(R.string.KGS)
    }
    ...
    companion object CREATOR : Parcelable.Creator<KGS> {
        override fun createFromParcel(parcel: Parcel): KGS {
            return KGS(parcel)
        }

        override fun newArray(size: Int): Array<KGS?> {
