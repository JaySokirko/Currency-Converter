...
class RON() : OrganizationCurrency() {
    @SerializedName("ask")
    @Expose
    ...
    companion object CREATOR : Parcelable.Creator<RON> {
        override fun createFromParcel(parcel: Parcel): RON {
            return RON(parcel)
        }

        override fun newArray(size: Int): Array<RON?> {
