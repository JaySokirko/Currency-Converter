...
class CommonOrganization() : Organization {
    ...
    companion object CREATOR : Parcelable.Creator<CommonOrganization> {
        override fun createFromParcel(parcel: Parcel): CommonOrganization {
            return CommonOrganization(parcel)
        }

        override fun newArray(size: Int): Array<CommonOrganization?> {
