...
class BYN() : OrganizationCurrency() {
    ...
    override fun getName(context: Context): String? {
        return context.resources.getString(R.string.belorussian_rubles)
    }

    override fun getImage(context: Context): Drawable? {
        return context.resources.getDrawable(R.drawable.ic_belarus_flag)
    }

    override fun getAbr(context: Context): String? {
        return context.resources.getString(R.string.BYN)
    }
    ...
    companion object CREATOR : Parcelable.Creator<BYN> {
        override fun createFromParcel(parcel: Parcel): BYN {
            return BYN(parcel)
        }

        override fun newArray(size: Int): Array<BYN?> {
