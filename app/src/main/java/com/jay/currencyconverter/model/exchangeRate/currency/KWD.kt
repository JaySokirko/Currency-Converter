...
class KWD() : OrganizationCurrency() {
    @SerializedName("ask")
    @Expose
    ...
    override fun getName(context: Context): String? {
        return context.resources.getString(R.string.kuwaiti_dinars)
    }

    override fun getImage(context: Context): Drawable? {
        return context.resources.getDrawable(R.drawable.ic_kuwait_flag)
    }

    override fun getAbr(context: Context): String? {
        return context.resources.getString(R.string.KWD)
    }
    ...
    companion object CREATOR : Parcelable.Creator<KWD> {
        override fun createFromParcel(parcel: Parcel): KWD {
            return KWD(parcel)
        }

        override fun newArray(size: Int): Array<KWD?> {
