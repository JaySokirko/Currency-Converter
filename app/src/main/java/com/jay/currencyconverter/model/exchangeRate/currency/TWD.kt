...
class TWD() : OrganizationCurrency() {
    @SerializedName("ask")
    @Expose
    ...
    override fun getName(context: Context): String? {
        return context.resources.getString(R.string.taiwan_dollars)
    }

    override fun getImage(context: Context): Drawable? {
        return context.resources.getDrawable(R.drawable.ic_taiwan_flag)
    }

    override fun getAbr(context: Context): String? {
        return context.resources.getString(R.string.TWD)
    }
    ...
    companion object CREATOR : Parcelable.Creator<TWD> {
        override fun createFromParcel(parcel: Parcel): TWD {
            return TWD(parcel)
        }

        override fun newArray(size: Int): Array<TWD?> {
