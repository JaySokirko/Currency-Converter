...
class TJS() : OrganizationCurrency() {
    @SerializedName("ask")
    @Expose
    ...
    override fun getName(context: Context): String? {
        return context.resources.getString(R.string.tajik_somons)
    }

    override fun getImage(context: Context): Drawable? {
        return context.resources.getDrawable(R.drawable.ic_tajikistan_flag)
    }

    override fun getAbr(context: Context): String? {
        return context.resources.getString(R.string.TJS)
    }
    ...
    companion object CREATOR : Parcelable.Creator<TJS> {
        override fun createFromParcel(parcel: Parcel): TJS {
            return TJS(parcel)
        }

        override fun newArray(size: Int): Array<TJS?> {
