...
class IQD() : OrganizationCurrency() {
    @SerializedName("ask")
    @Expose
    ...
    override fun getName(context: Context): String? {
        return context.resources.getString(R.string.iraqi_dinars)
    }

    override fun getImage(context: Context): Drawable? {
        return context.resources.getDrawable(R.drawable.ic_iraq_flag)
    }

    override fun getAbr(context: Context): String? {
        return context.resources.getString(R.string.IQD)
    }
    ...
    companion object CREATOR : Parcelable.Creator<IQD> {
        override fun createFromParcel(parcel: Parcel): IQD {
            return IQD(parcel)
        }

        override fun newArray(size: Int): Array<IQD?> {
