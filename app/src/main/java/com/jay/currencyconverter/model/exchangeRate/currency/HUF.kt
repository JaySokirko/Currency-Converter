...
class HUF() : OrganizationCurrency() {
    @SerializedName("ask")
    @Expose
    ...
    override fun getName(context: Context): String? {
        return context.resources.getString(R.string.hungarian_forints)
    }

    override fun getImage(context: Context): Drawable? {
        return context.resources.getDrawable(R.drawable.ic_hungary_flag)
    }

    override fun getAbr(context: Context): String? {
        return context.resources.getString(R.string.HUF)
    }
    ...
    companion object CREATOR : Parcelable.Creator<HUF> {
        override fun createFromParcel(parcel: Parcel): HUF {
            return HUF(parcel)
        }

        override fun newArray(size: Int): Array<HUF?> {
