...
class AED() : OrganizationCurrency() {
    ...
    override fun getName(context: Context): String? {
        return context.resources.getString(R.string.uae_dirhams)
    }

    override fun getImage(context: Context): Drawable {
        return context.resources.getDrawable(R.drawable.ic_arabien_emirates_flag)
    }

    override fun getAbr(context: Context): String? {
        return context.resources.getString(R.string.AED)
    }
    ...
    companion object CREATOR : Parcelable.Creator<AED> {
        override fun createFromParcel(parcel: Parcel): AED {
            return AED(parcel)
        }

        override fun newArray(size: Int): Array<AED?> {
