...
class GEL() : OrganizationCurrency() {
    ...
    override fun getName(context: Context): String? {
        return context.resources.getString(R.string.georgian_lari)
    }

    override fun getImage(context: Context): Drawable? {
        return context.resources.getDrawable(R.drawable.ic_georgia_flag)
    }

    override fun getAbr(context: Context): String? {
        return context.resources.getString(R.string.GEL)
    }
    ...
    companion object CREATOR : Parcelable.Creator<GEL> {
        override fun createFromParcel(parcel: Parcel): GEL {
            return GEL(parcel)
        }

        override fun newArray(size: Int): Array<GEL?> {
