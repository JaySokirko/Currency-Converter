...
class NbuActivity : NavigationActivity(), ErrorDialog.ErrorDialogClickListener {
    ...
    private val layoutParamsAnimator = LayoutParamsAnimator()
        ...
        nbuActivityVM.exchangeRateObserver.observe(this, Observer {
                ...
                if (response.error == null) {
                    response.data?.let { nbuCurrenciesList: List<Nbu> ->
                        ...
                        displayCurrenciesAdapter.setItems(nbuCurrenciesList)
                        nbuExchangeAdapter.setItems(nbuCurrenciesList)
                        chartCurrenciesAdapter.setItems(nbuCurrenciesList)
                    }
                } else {
    ...
    private fun onDisplayedCurrenciesListChanged() {
        NbuCurrenciesDisplay.filteredCurrenciesToDisplay.observe(this,
            Observer { listToDisplay: MutableMap<Nbu, Boolean> ->
//                displayCurrenciesAdapter.setItems(listToDisplay)
            })
    }
